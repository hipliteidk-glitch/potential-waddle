...
The included APK is the `1.0.2` compatibility release. It uses the unique package ID `com.animenotify.mobile`, includes both v1 and v2 signatures for older vendor installers, targets Android 9 (API 28), and supports Android 7.0+ (API 24). It is zip-aligned and signed with a dedicated AnimeNotify release certificate for direct installation.
